# SoccerFestival
My Soccer Festival repo holds the first capstone project at Microverse
<a name="readme-top"></a>
...
# 📖 SOCCER FESTIVAL <a name="about-project"></a>


**soccer festival** is a simple project to demonstrate my competence as a web developer by literally showcasing my development skills.
...
- **A home page with general information including speakers and Contact Information**
- **Dynamically generated HTML using JS**

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🚀 Live Demo <a name="live-demo"></a>
To visit the live version of this project <a href="https://marvin-nyalik.github.io/SoccerFestival/"> click here</a>

## 💻 Getting Started <a name="getting-started"></a>
To get a local copy up and running, follow these steps.
1. Clone this repository
   run 
   **git clone https://marvin-nyalik.github.io/SoccerFestival/**
...
> Run this command '**https://marvin-nyalik.github.io/SoccerFestival/**'
<p align="right">(<a href="#readme-top">back to top</a>)</p>
...
- [ ] **Addition of links for all navbar items**
- [ ] **Adding a CSS framework for styling**
- [ ] **Implementing email communication directly with UEFA and CAF**
